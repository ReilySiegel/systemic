...
(define emacs-packages
  (list
   ...
   emacs-forge emacs-paredit emacs-yasnippet emacs-yasnippet-snippets
   emacs-clojure-mode emacs-cider emacs-gnuplot emacs-lsp-java emacs-esup
   emacs-flyspell-correct emacs-racket-mode emacs-geiser emacs-yaml-mode mu
   emacs-mu4e-alert emacs-plantuml-mode emacs-org emacs-org-super-agenda
